# 拷贝自 https://github.com/PaddlePaddle/PaddleGAN/blob/develop/ppgan/metrics/inception.py

import paddle
import paddle.nn as nn
from paddle.nn import Conv2D, AvgPool2D, MaxPool2D, BatchNorm, AdaptiveAvgPool2D
